...
article1 = Article.create(title: Faker::Name.name, address: Faker::Address.city, category: Faker::Commerce.department, content: Faker::Lorem.paragraph(sentence_count: 10))
...
article2 = Article.create(title: Faker::Name.name, address: Faker::Address.city, category: Faker::Commerce.department, content: Faker::Lorem.paragraph(sentence_count: 10))
...
article3 = Article.create(title: Faker::Name.name, address: Faker::Address.city, category: Faker::Commerce.department, content: Faker::Lorem.paragraph(sentence_count: 10))
...
article4 = Article.create(title: Faker::Name.name, address: Faker::Address.city, category: Faker::Commerce.department, content: Faker::Lorem.paragraph(sentence_count: 10))
...
article5 = Article.create(title: Faker::Name.name, address: Faker::Address.city, category: Faker::Commerce.department, content: Faker::Lorem.paragraph(sentence_count: 10))
...
article6 = Article.create(title: Faker::Name.name, address: Faker::Address.city, category: Faker::Commerce.department, content: Faker::Lorem.paragraph(sentence_count: 10))
...
article7 = Article.create(title: Faker::Name.name, address: Faker::Address.city, category: Faker::Commerce.department, content: Faker::Lorem.paragraph(sentence_count: 10))
...
article8 = Article.create(title: Faker::Name.name, address: Faker::Address.city, category: Faker::Commerce.department, content: Faker::Lorem.paragraph(sentence_count: 10))
...
article9 = Article.create(title: Faker::Name.name, address: Faker::Address.city, category: Faker::Commerce.department, content: Faker::Lorem.paragraph(sentence_count: 10))
...
article10 = Article.create(title: Faker::Name.name, address: Faker::Address.city, category: Faker::Commerce.department, content: Faker::Lorem.paragraph(sentence_count: 10))
